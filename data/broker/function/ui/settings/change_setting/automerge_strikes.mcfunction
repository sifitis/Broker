...
execute if score @s zz.broker.uservar.setting.automerge.strikes matches ..-1 run scoreboard players set @s zz.broker.uservar.setting.automerge.strikes 9999999
execute if score @s zz.broker.uservar.setting.automerge.strikes matches 4 run scoreboard players set @s zz.broker.uservar.setting.automerge.strikes -1
...
execute if score @s zz.broker.uservar.setting.automerge.strikes matches 9999999.. run scoreboard players set @s zz.broker.uservar.setting.automerge.strikes 1
