...
execute if score C0 zz.broker.util.automerge.merge matches 64.. run function broker:util/automerge/run_merge/calc_c
execute if score S0 zz.broker.util.automerge.merge matches 64.. run function broker:util/automerge/run_merge/calc_s
execute if score G0 zz.broker.util.automerge.merge matches 64.. run function broker:util/automerge/run_merge/calc_g
execute if score P0 zz.broker.util.automerge.merge matches 64.. run function broker:util/automerge/run_merge/calc_p
