...
scoreboard players operation N zz.broker.util.automerge.merge = P1 zz.broker.util.automerge.merge
scoreboard players operation N zz.broker.util.automerge.merge /= .64 zz.broker.const
scoreboard players operation M1 zz.broker.util.automerge.merge += N zz.broker.util.automerge.merge
scoreboard players operation N zz.broker.util.automerge.merge *= .64 zz.broker.const
