$summon area_effect_cloud ~ ~ ~ {Particle:{type:"angry_villager"},\
...
tellraw @a[tag=command_executor,distance=..10] [{"text":"                                    "},{"text":"[Confirm]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function broker:util/summon/delete_spawnpoint/confirmed"}}]
tellraw @a[tag=command_executor,distance=..10] {"text":""}