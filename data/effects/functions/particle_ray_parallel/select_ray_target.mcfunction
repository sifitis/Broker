...
tp @e[name=ray_tracer] @e[tag=RAY_CASTER,limit=1,distance=..32]

#trace the ray#
execute if entity @e[distance=..32,scores={ACTIVE_TARGET=1..}] run function effects:particle_ray_parallel/trace_ray