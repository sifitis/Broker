...
###		Subset of effects:particle_ray_series/setup_ray		###
...
execute if entity @e[distance=..32,tag=RAY_TARGET] run function effects:particle_ray_series/select_ray_target
